package com.reservationhotels.controller;
...
import com.reservationhotels.services.ReservationService;
...
@Controller
public class HotelReservationController<AnonymousAuthenticationToken> {
	...
	public String processRegistrationForm( @ModelAttribute("newUser") CurrentUser currentUser,
	...
	public String proceedReservation(@ModelAttribute("newRes") CurrentReservation currentReservation,
			BindingResult theBindingResult, Model model) {
	...
	public String logoutPage(HttpServletRequest request, HttpServletResponse response) {
		...
		ContextAware SecurityContextHolder = null;
		Authentication auth = SecurityContextHolder.getContext().getAuthentication();
		if (auth != null) {
